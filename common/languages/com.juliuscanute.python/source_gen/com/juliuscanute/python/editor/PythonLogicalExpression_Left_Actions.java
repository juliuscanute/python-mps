...
public class PythonLogicalExpression_Left_Actions {
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        if (!(SConceptOperations.isExactly(SNodeOperations.asSConcept(SNodeOperations.getConcept(SLinkOperations.getTarget(node, LINKS.left$tnbf))), SNodeOperations.asSConcept(CONCEPTS.PythonExpression$6o)))) {
          SLinkOperations.setTarget(node, LINKS.left$tnbf, SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0x3b1a18ff6fd44977L, 0xba7ea7ddc907c639L, 0x46cfc4ee6659906bL, "com.juliuscanute.python.structure.PythonExpression")));
          return;
        }
        SNode rightExpression = SLinkOperations.getTarget(node, LINKS.right$tnDh);
