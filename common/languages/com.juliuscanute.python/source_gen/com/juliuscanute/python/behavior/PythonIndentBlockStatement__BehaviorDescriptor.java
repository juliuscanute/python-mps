...
public final class PythonIndentBlockStatement__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x3b1a18ff6fd44977L, 0xba7ea7ddc907c639L, 0x49693ebcac9426e0L, "com.juliuscanute.python.structure.PythonIndentBlockStatement");
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getScope_id52_Geb4QFgX, getScope_id52_Geb4QDV$);
  ...
  /*package*/ static Scope getScope_id52_Geb4QFgX(@NotNull SNode __thisNode__, final SAbstractConcept kind, SContainmentLink link, int index) {
    ...
    Sequence.fromIterable(SNodeOperations.ofConcept(ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.body$LHHG)).headListSequence(index), CONCEPTS.ScopeProvider$aq)).visitAll(new IVisitor<SNode>() {
      public void visit(SNode it) {
        scope.addScope(ScopeProvider__BehaviorDescriptor.getScope_id52_Geb4QDV$.invoke(it, kind, null));
      }
    });
    if (index < ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.body$LHHG)).count()) {
      scope.addScope(ScopeUtils.lazyParentScope(__thisNode__, kind));
    }
    return scope;
  }
  /*package*/ static Scope getScope_id52_Geb4QDV$(@NotNull SNode __thisNode__, SAbstractConcept kind, SNode child) {
    int index = ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.body$LHHG)).count();
    if ((child != null) && SNodeOperations.isInstanceOf(child, CONCEPTS.PythonStatement$hN)) {
      index = ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.body$LHHG)).indexOf(SNodeOperations.cast(child, CONCEPTS.PythonStatement$hN));
    }
    return ScopeProvider__BehaviorDescriptor.getScope_id52_Geb4QFgX.invoke(__thisNode__, kind, LINKS.body$LHHG, ((int) index));
  }

  /*package*/ PythonIndentBlockStatement__BehaviorDescriptor() {
  }
