...
public final class PythonTryExceptStatement__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x3b1a18ff6fd44977L, 0xba7ea7ddc907c639L, 0x4e7b579a88e103dcL, "com.juliuscanute.python.structure.PythonTryExceptStatement");
  ...
  /*package*/ static Scope getScope_id52_Geb4QDV$(@NotNull SNode __thisNode__, SAbstractConcept kind, SNode child) {
    ...
    if ((SLinkOperations.getTarget(SLinkOperations.getTarget(__thisNode__, LINKS.expression$u0bk), LINKS.renamedIdentifier$nuAh) != null)) {
      scope.addScope(new NamedElementsScope(SLinkOperations.getTarget(SLinkOperations.getTarget(__thisNode__, LINKS.expression$u0bk), LINKS.renamedIdentifier$nuAh)));
    } else {
      scope.addScope(new NamedElementsScope(SLinkOperations.getTarget(SLinkOperations.getTarget(__thisNode__, LINKS.expression$u0bk), LINKS.actualIdentifier$nzZC)));
    }
    return scope;
  }

  /*package*/ PythonTryExceptStatement__BehaviorDescriptor() {
  }
