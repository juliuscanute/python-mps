...
/*package*/ class PythonNoneLiteral_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public PythonNoneLiteral_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_xvohfs_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_xvohfs_a0");
